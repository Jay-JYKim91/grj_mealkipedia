...
const CategoryTag = (props: TagProps) => {
    return (
        <span
            className={
                "p-2 py-px mb-1 mr-2 border-2 rounded-3xl font-body2_font border-indigo-300 bg-indigo-300 text-indigo-700"
            }
        >
            {props.content}
        </span>
...
const AreaTag = (props: TagProps) => {
    return (
        <span
            className={
                "p-2 py-px mb-1 mr-2 border-2 rounded-3xl font-body2_font border-lime-300 bg-lime-300 text-lime-700"
            }
        >
            {props.content}
        </span>
