...
const AreaTag = (props: TagProps) => {
    return (
        <span
            className={
                "p-2 py-px mb-1 mr-2 border-2 rounded-3xl border-lime-300 bg-lime-300 text-lime-700"
            }
        >
            {props.content}
        </span>
...
const RestTag = (props: TagProps) => {
    return (
        <span
            className={
                "p-2 py-px mb-1 mr-2 border-2 rounded-3xl border-orange-300 bg-orange-300 text-orange-700"
            }
        >
            {props.content}
        </span>
