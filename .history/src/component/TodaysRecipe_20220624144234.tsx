...
const TodaysRecipe: React.FC<RecipeType> = ({ 
    ...
    const { isLoading, isError, data, error } = useQuery('getDefaultRecipe', () => apiMeals.getDefaultRecipe());

    const { idMeal, strArea, strCategory, strMeal, strTags, strMealThumb, strInstructions } = data;
