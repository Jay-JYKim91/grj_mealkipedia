...
const Home: React.FC = () => {
    return (
        <>
            <div className="px-6 md:px-9 lg:px-12 py-40 bg-cover bg-[url('../public/main_background.jpg')] text-center lg:text-right">
            ...
            <TodaysRecipe divStyle="px-6 md:px-9 lg:px-12 py-6 lg:py-12 max-w-7xl m-auto" />
        </>
    );
};
