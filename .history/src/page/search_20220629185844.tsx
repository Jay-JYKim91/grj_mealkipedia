            ...
            <div>
                ...
                }
                {
                    data && data.map((item: Recipe) => {
                        ...
                        return <div className="mb-5 border-white rounded-lg shadow-2xl" key={item.idMeal} onClick={(e) => handleNavigateToResult(e, item.idMeal)}>
                            <img src={item.strMealThumb} alt={item.strMeal}
                                className="lg:pr-4 max-w-full max-h-xs rounded-lg" />
