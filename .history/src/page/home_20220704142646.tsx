        ...
        <>
            <div className="px-6 md:px-9 lg:px-12 py-40 bg-cover bg-[url('images/main_background.jpg')] text-center lg:text-right">
                <div className="max-w-7xl m-auto">
                    ...
                    <SearchBar divStyle="flex justify-center lg:justify-end" inputStyle="p-2 lg:p-4 w-full text-2xl font-body1_font rounded-l-lg border-2 border-gray-300"
                        imageStyle="max-h-[40px]" buttonStyle="p-2 bg-gray-300 rounded-r-lg" />
                </div>
