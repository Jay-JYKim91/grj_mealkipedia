            ...
            <div>
                ...
                }
                {
                    data && data.map((item: Recipe) => {
                        ...
                        return <div className="pb-2" key={item.idMeal} onClick={(e) => handleNavigateToResult(e, item.idMeal)}>
                            ...
                            <button 
                                className="p-1 mt-2 border-2 min-h-[100px] border-orange-900 rounded-lg 
