                ...
                <div className="flex flex-col md:flex-row md:flex-wrap md:justify-between">
                    {data &&
                        data.map((item: Recipe) => {
                            ...
                            return (
                                <div
                                    className="mb-5 border-white rounded-lg shadow-3xl md:max-w-[340px] lg:max-w-[300px] xl:max-w-[285px] relative hover:translate-x-[-4px] hover:translate-y-[-4px]"
                                    key={item.idMeal}
                                    onClick={(
                                        e: React.MouseEvent<
                                            HTMLDivElement,
                                ...
                                >
                                    ...
                                    <div className="p-4">
                                        ...
                                        <p className="font-body1_font text-2xl pb-12 mt-4">
                                            {item.strMeal}
                                        </p>
