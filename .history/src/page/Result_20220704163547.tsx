...
const Result: React.FC = () => {
    ...
    return (
        <div className="px-6 md:px-9 lg:px-12 my-6 max-w-7xl m-auto">
            ...
            <div className="py-2 flex flex-wrap">
                ...
                {strTags &&
                    strTags.split(',').map(
                        (tag: string) => (
                        tag && tag !== strCategory && (
                            <Tag type="restTag" content={tag} key={tag} />
                        )
                    )
                    // {
            ...
            {strYoutube && <div className="flex justify-end mb-2">
            ...
            <div className="flex flex-col md:flex-row font-body2_font">
                ...
                <div className="py-2 md:py-0">
                    <p className="font-body1_font text-2xl md:text-3xl py-2 md:pt-0">Ingredients</p>
                    {
                        ingredientsArray.map((ingredient) => {
                            return (
                                <p className="flex items-center text-slate-600" key={ingredient}>
