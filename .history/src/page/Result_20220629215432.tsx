        ...
        <div className="px-6 md:px-9 lg:px-12 my-6 max-w-7xl m-auto">
            ...
            <div className="flex flex-col md:flex-row font-body2_font">
                ...
                <div className="py-2 md:py-0">
                    <p className="font-body1_font text-2xl py-2 md:pt-0">Ingredients</p>
                    {
                    ...
                    {
                        strInstructions.split('\r\n').filter(n => n).map((instruction: string, index: number) => {
                            return (
                                // <p>STEP {}</p>
                                <p className="pb-2 font-body2_font text-lg" key={Math.random()}>
                                    STEP{index + 1} <br/> {instruction}
                                </p>
                            )
                        })
                    }
