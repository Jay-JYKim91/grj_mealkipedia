                ...
                <div className="flex flex-col md:flex-row md:flex-wrap md:justify-between">
                    {data &&
                        data.map((item: Recipe) => {
                            ...
                            return (
                                <div
                                    className="mb-5 border-white rounded-lg shadow-2xl md:max-w-[360px] lg:max-w-[300px] xl:max-w-[285px]"
                                    key={item.idMeal}
                                >
                                    <img
                                    ...
                                    />
                                    <div className="p-4 relative lg:height-[360px]">
                                        ...
                                        <div className="flex justify-end absolute inset-x-4">
                                            <button
                                                type="button"
