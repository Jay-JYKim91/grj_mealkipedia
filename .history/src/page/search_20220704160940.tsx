                ...
                <div className="flex flex-col md:flex-row md:flex-wrap md:justify-between">
                    {data &&
                        data.map((item: Recipe) => {
                            ...
                            return (
                                <div
                                    className="mb-5 border-white rounded-lg shadow-2xl md:max-w-[340px] lg:max-w-[300px] xl:max-w-[285px]"
                                    key={item.idMeal}
                                >
                                    <img
                                    ...
                                    <div className="p-4">
                                        ...
                                        <p className="font-body1_font text-2xl">
                                            {item.strMeal}
                                        </p>
                                        ...
                                        <div className="flex justify-end">
                                            <button
                                                ...
                                                onClick={(e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => handleNavigateToResult(e, item.idMeal)}
                                                >
                                                    Read More
                                            </button>
                                        </div>
