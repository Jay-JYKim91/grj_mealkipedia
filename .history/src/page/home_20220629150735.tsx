...
const Home: React.FC = () => {
    return (
        <>
            <div 
                className="px-6 md:px-9 lg:px-12 py-36 bg-cover bg-[url('images/main_background.jpg')] 
                            text-center lg:text-right text-amber-900 drop-shadow-[4px_3px_0px_#fff, 9px_8px_0px_rgba(0,0,0,0.15)]">
                <h1 
