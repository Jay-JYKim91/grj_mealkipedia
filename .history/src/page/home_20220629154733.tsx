        ...
        <>
            <div 
                ...
                <div className="max-w-7xl m-auto">
                    <h1 
                        className="font-body1_font text-5xl lg:text-7xl mb-8 drop-shadow-[2.5px_2.5px_0.5px_rgba(255,255,255,0.8)]">
                            Find a Recipe
                    </h1>
                    <SearchBar 
            ...
            <TodaysRecipe divStyle="px-6 md:px-9 lg:px-9 xl:px-0 py-6 lg:py-12 max-w-7xl m-auto" />
        </>
    )
};
